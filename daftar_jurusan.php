...
<div class="col-sm-8 text-left"> 
      <h2 class="text-center">DAFTAR JURUSAN</h2>
      <form id="form1" name="form1" method="post" action="daftar_jurusan.php">
...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
        			...
        			<td>".$data[2]."</td>
              <td>".$data[3]."</td>    
                    <td><a href=\"detail_jurusan.php?id=".$data[0]."\"><i class='glyphicon glyphicon-search'></i></a></td>
        		</tr>   
        	";      
			}
                    ?>
